---
name: code-reviewer
description: 'Reviews Washer changed files against dynamically discovered .claude/rules, FSD boundaries, UI conventions, API/data coherence, security basics, and validation results. Use for review requests and before final delivery of multi-file changes.'
