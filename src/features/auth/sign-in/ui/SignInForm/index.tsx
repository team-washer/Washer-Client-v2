...
const SignInForm = () => {
  return (
    <div className="w-110 rounded-[20px] bg-white px-7 py-10 shadow-[0_12px_40px_rgba(0,0,0,0.06)]">
      ...
      <OAuthLoginButton className="flex py-3 px-[2.09375rem] w-full justify-center items-center gap-2.5 self-stretch rounded-lg bg-blue-500 text-white font-semibold" />
    </div>
  );
};
