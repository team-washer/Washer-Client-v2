      ...
      <div className="mt-4 flex flex-col gap-4">
        ...
        <div>
          ...
          <div className="flex flex-wrap gap-2">
            <button className="inline-flex h-9 min-w-10 items-center justify-center rounded-lg border border-[#D9D9DE] bg-white px-3 text-sm text-[#7A7A80]">
              2
            </button>
            <button className="inline-flex h-9 min-w-10 items-center justify-center rounded-lg bg-[#4D83F6] px-3 text-sm text-white">
              3
            </button>
            <button className="inline-flex h-9 min-w-10 items-center justify-center rounded-lg border border-[#D9D9DE] bg-white px-3 text-sm text-[#7A7A80]">
              4
